...
from config import PRICING_DEAL_MIN_DISCOUNT, PRICING_DEAL_MIN_MARGIN, PRICING_DEAL_MIN_SCORE
from services.ebay_sold_client import EbaySoldError, EbaySoldListing, EbaySoldRateLimitError, get_recent_sales
...
def evaluate_listing(listing) -> DealResult:
    ...
    if len(comparable_sales) < 3:
        return DealResult(
            ...
            reason="not_enough_recent_sales",
    ...
    reference_price = round(float(median(comparable_prices)), 2)
