...
start "TCG Bot" powershell -NoExit -ExecutionPolicy Bypass -Command "Set-Location '%PROJECT_DIR%'; Start-Sleep -Seconds 4; $env:SITE_URL='%LOCAL_SITE%'; $env:MOBILE_APP_URL='%LOCAL_SITE%'; $env:APP_API_URL='%LOCAL_LISTINGS_API%'; $env:APP_API_STATUS_URL='%LOCAL_STATUS_API%'; $env:APP_API_ENABLED='true'; $env:ENABLE_WALLAPOP='true'; $env:WALLAPOP_INLINE_IN_MAIN_BOT='true'; $env:WALLAPOP_SEND_TELEGRAM='false'; $env:WALLAPOP_MAX_ITEMS_PER_RUN='6'; $env:WALLAPOP_HEADLESS='true'; $env:WALLAPOP_DELAY_MIN_SECONDS='2'; $env:WALLAPOP_DELAY_MAX_SECONDS='5'; python vinted_olx_bot.py"
