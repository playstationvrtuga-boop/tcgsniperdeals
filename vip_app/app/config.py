...
class Config:
    ...
    LOG_PERFORMANCE = _bool_env_default("LOG_PERFORMANCE", False)
    LOG_FEED_TIMING = _bool_env_default("LOG_FEED_TIMING", False)
    FEED_CACHE_TTL_SECONDS = int(os.getenv("FEED_CACHE_TTL_SECONDS", "5"))
    FEED_HTTP_CACHE_SECONDS = int(os.getenv("FEED_HTTP_CACHE_SECONDS", "5"))
    FEED_OPTIONS_CACHE_TTL_SECONDS = int(os.getenv("FEED_OPTIONS_CACHE_TTL_SECONDS", "60"))
    FEED_PAGE_SIZE = int(os.getenv("FEED_PAGE_SIZE", "24"))
    FEED_PAGE_MAX_SIZE = int(os.getenv("FEED_PAGE_MAX_SIZE", "48"))
